...
（本包需要 Lethe、ModularSkillScripts，包含专用插件 NikaidouHiro.dll）
...
- 在良秀的人格列表中选择「二阶堂希罗」（人格 ID：104970）
- 更新时，先移除旧版 `NikaidouHiro-Identity` 文件夹，再放入新版文件夹，并替换 DLL
